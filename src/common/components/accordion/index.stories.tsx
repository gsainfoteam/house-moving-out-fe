...
export const Default: Story = {
  render: () => (
    <Accordion.Root defaultOpen={false}>
      ...
      <Accordion.Content>
        <ul className="text-body text-text-primary flex flex-col gap-2">
  ...
  render: () => (
    <Accordion.Root defaultOpen={true}>
      <Accordion.Header>
        ...
        <span className="text-primary ml-auto">(5/5)</span>
      </Accordion.Header>
      <Accordion.Content>
        <ul className="text-body text-text-primary flex flex-col gap-3">
