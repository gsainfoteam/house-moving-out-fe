                    ...
                    overlay.open(() => (
                      <Dialog.Root closeOnBackdrop>
                        <Dialog.Header>
                          ...
                          <Dialog.Description>
                            이 다이얼로그는 드로어 안에서 열렸습니다. ESC를 누르면 이 다이얼로그가
                            먼저 닫히고, 다시 ESC를 누르면 드로어가 닫힙니다.
                          </Dialog.Description>
                        </Dialog.Header>
                        <Dialog.Body>
                          <p className="text-body text-text-secondary">
                    ...
                    overlay.open(() => (
                      <Drawer.Root side="right" closeOnBackdrop>
                        <Drawer.Header>
                          ...
                          <Drawer.Description>
                            이 드로어는 다이얼로그 안에서 열렸습니다. ESC를 누르면 이 드로어가 먼저
                            닫히고, 다시 ESC를 누르면 다이얼로그가 닫힙니다.
                          </Drawer.Description>
                        </Drawer.Header>
                        <Drawer.Body>
                      ...
                      <Drawer.Root side="bottom" closeOnBackdrop>
                        ...
                        <Drawer.Footer orientation="vertical">
                          <Button
                            ...
                            onClick={() =>
                              overlay.open(() => (
                                <Dialog.Root closeOnBackdrop className="w-80">
                                  <Dialog.Header>
                                    <Dialog.Title>Second Dialog</Dialog.Title>
                                    <Dialog.Description>
                                      세 번째로 열린 오버레이입니다. ESC를 누르면 이 다이얼로그가
                                      먼저 닫힙니다.
                                    </Dialog.Description>
                                  </Dialog.Header>
                                  <Dialog.Body>
