                        ...
                        <Dialog.Root closeOnBackdrop>
                          <Dialog.Content>
                            <Dialog.Header>
                              ...
                              <Dialog.Description>
                                이 다이얼로그는 드로어 안에서 열렸습니다. ESC를 누르면 이
                                다이얼로그가 먼저 닫히고, 다시 ESC를 누르면 드로어가 닫힙니다.
                              </Dialog.Description>
                            </Dialog.Header>
                            <Dialog.Body>
                              <p className="text-body text-text-gray">
                                overlay 스택이 제대로 동작하면, 가장 최근에 연 오버레이가 항상
                                최상단에 위치합니다.
                              </p>
                            </Dialog.Body>
                        ...
                        <Drawer.Root side="right" closeOnBackdrop>
                          <Drawer.Content>
                            <Drawer.Header>
                              ...
                              <Drawer.Description>
                                이 드로어는 다이얼로그 안에서 열렸습니다. ESC를 누르면 이 드로어가
                                먼저 닫히고, 다시 ESC를 누르면 다이얼로그가 닫힙니다.
                              </Drawer.Description>
                            </Drawer.Header>
                            <Drawer.Body>
                        ...
                        <Drawer.Root side="bottom" closeOnBackdrop>
                          <Drawer.Content>
                            <Drawer.Header>
                              ...
                              <Drawer.Description>
                                두 번째로 열린 오버레이입니다. 아래 버튼을 눌러 세 번째 오버레이를
                                열어보세요.
                              </Drawer.Description>
                            </Drawer.Header>
                            <Drawer.Body>
                                    ...
                                    <Dialog.Root closeOnBackdrop>
                                      <Dialog.Content className="w-80">
                                        <Dialog.Header>
                                          ...
                                          <Dialog.Description>
                                            세 번째로 열린 오버레이입니다. ESC를 누르면 이
                                            다이얼로그가 먼저 닫힙니다.
                                          </Dialog.Description>
                                        </Dialog.Header>
                                        <Dialog.Body>
                                          <p className="text-body text-text-gray">
                                            오버레이 스택 순서: 1. First Dialog → 2. Drawer → 3.
                                            Second Dialog (최상단)
                                          </p>
                                        </Dialog.Body>
                                        <Dialog.Footer orientation="vertical">
