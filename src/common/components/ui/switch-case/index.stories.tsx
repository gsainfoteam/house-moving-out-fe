...
const caseBy: Partial<Record<Status, React.ReactNode>> = {
  idle: <div className="text-body text-text-secondary">대기 중</div>,
  loading: <div className="text-body text-primary">로딩 중...</div>,
...
export const Idle: Story = {
  args: {
    value: 'idle',
    caseBy,
    defaultComponent: <div className="text-body text-text-secondary">알 수 없는 상태</div>,
  },
};
...
export const DefaultCase: Story = {
  args: {
    ...
    caseBy,
    defaultComponent: <div className="text-body text-text-secondary">매칭되는 케이스 없음</div>,
  },
};
