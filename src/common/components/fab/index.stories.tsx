  ...
  render: () => (
    <div className="bg-bg-surface h-screen w-screen p-8">
      <div className="text-text-primary">
        <h1 className="text-display mb-4">Fab 컴포넌트 예시</h1>
...
export const SingleItem: Story = {
  render: () => (
    <div className="bg-bg-surface h-screen w-screen p-8">
      <div className="text-text-primary">
        <h1 className="text-display mb-4">단일 항목</h1>
...
export const TwoItems: Story = {
  render: () => (
    <div className="bg-bg-surface h-screen w-screen p-8">
      <div className="text-text-primary">
        <h1 className="text-display mb-4">두 개의 항목</h1>
...
export const WithActions: Story = {
  render: () => (
    <div className="bg-bg-surface h-screen w-screen p-8">
      <div className="text-text-primary">
        <h1 className="text-display mb-4">클릭 액션 예시</h1>
